...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '35ab9109450fa5e32dda254f954fb313c5444c9a080422a484e9003d3a004625_1' => 'get35ab9109450fa5e32dda254f954fb313c5444c9a080422a484e9003d3a0046251Service',
            '580009ca1d7e7987203a82074b0fbdbbf6d7c292bd8b3421444de822b0ad1d41_1' => 'get580009ca1d7e7987203a82074b0fbdbbf6d7c292bd8b3421444de822b0ad1d411Service',
            '580009ca1d7e7987203a82074b0fbdbbf6d7c292bd8b3421444de822b0ad1d41_2' => 'get580009ca1d7e7987203a82074b0fbdbbf6d7c292bd8b3421444de822b0ad1d412Service',
            '580009ca1d7e7987203a82074b0fbdbbf6d7c292bd8b3421444de822b0ad1d41_3' => 'get580009ca1d7e7987203a82074b0fbdbbf6d7c292bd8b3421444de822b0ad1d413Service',
    ...
    /**
     * Gets the '35ab9109450fa5e32dda254f954fb313c5444c9a080422a484e9003d3a004625_1' service.
     *
     ...
     */
    protected function get35ab9109450fa5e32dda254f954fb313c5444c9a080422a484e9003d3a0046251Service()
    {
        return $this->services['35ab9109450fa5e32dda254f954fb313c5444c9a080422a484e9003d3a004625_1'] = new \Symfony\Component\Form\ResolvedFormTypeFactory();
    }

    /**
     * Gets the '580009ca1d7e7987203a82074b0fbdbbf6d7c292bd8b3421444de822b0ad1d41_1' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get580009ca1d7e7987203a82074b0fbdbbf6d7c292bd8b3421444de822b0ad1d411Service()
    {
        return $this->services['580009ca1d7e7987203a82074b0fbdbbf6d7c292bd8b3421444de822b0ad1d41_1'] = new \Swift_Transport_Esmtp_Auth_CramMd5Authenticator();
    }

    /**
     * Gets the '580009ca1d7e7987203a82074b0fbdbbf6d7c292bd8b3421444de822b0ad1d41_2' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get580009ca1d7e7987203a82074b0fbdbbf6d7c292bd8b3421444de822b0ad1d412Service()
    {
        return $this->services['580009ca1d7e7987203a82074b0fbdbbf6d7c292bd8b3421444de822b0ad1d41_2'] = new \Swift_Transport_Esmtp_Auth_LoginAuthenticator();
    }

    /**
     * Gets the '580009ca1d7e7987203a82074b0fbdbbf6d7c292bd8b3421444de822b0ad1d41_3' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get580009ca1d7e7987203a82074b0fbdbbf6d7c292bd8b3421444de822b0ad1d413Service()
    {
        return $this->services['580009ca1d7e7987203a82074b0fbdbbf6d7c292bd8b3421444de822b0ad1d41_3'] = new \Swift_Transport_Esmtp_Auth_PlainAuthenticator();
    }
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/matko/GitHub/LiveVotingBundle/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/home/matko/GitHub/LiveVotingBundle/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/home/matko/GitHub/LiveVotingBundle/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/home/matko/GitHub/LiveVotingBundle/app/Resources');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_6b58c8c70797313f88761345dc2a019a14b601458ee6b576cb0799ec2fa1fabe');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_6b58c8c70797313f88761345dc2a019a14b601458ee6b576cb0799ec2fa1fabe');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_6b58c8c70797313f88761345dc2a019a14b601458ee6b576cb0799ec2fa1fabe');
        ...
        $d->setProxyDir('/home/matko/GitHub/LiveVotingBundle/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/home/matko/GitHub/LiveVotingBundle/app/Resources');
    }
    ...
    {
        return $this->services['form.resolved_type_factory'] = new \Symfony\Component\Form\Extension\DataCollector\Proxy\ResolvedTypeFactoryDataCollectorProxy($this->get('35ab9109450fa5e32dda254f954fb313c5444c9a080422a484e9003d3a004625_1'), $this->get('data_collector.form'));
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/home/matko/GitHub/LiveVotingBundle/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/home/matko/GitHub/LiveVotingBundle/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/home/matko/GitHub/LiveVotingBundle/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/home/matko/GitHub/LiveVotingBundle/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/home/matko/GitHub/LiveVotingBundle/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/home/matko/GitHub/LiveVotingBundle/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/home/matko/GitHub/LiveVotingBundle/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        $a = new \Swift_Transport_Esmtp_AuthHandler(array(0 => $this->get('580009ca1d7e7987203a82074b0fbdbbf6d7c292bd8b3421444de822b0ad1d41_1'), 1 => $this->get('580009ca1d7e7987203a82074b0fbdbbf6d7c292bd8b3421444de822b0ad1d41_2'), 2 => $this->get('580009ca1d7e7987203a82074b0fbdbbf6d7c292bd8b3421444de822b0ad1d41_3')));
        $a->setUsername(NULL);
        $a->setPassword(NULL);
        $a->setAuthMode(NULL);
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/home/matko/GitHub/LiveVotingBundle/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/home/matko/GitHub/LiveVotingBundle/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/home/matko/GitHub/LiveVotingBundle/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/home/matko/GitHub/LiveVotingBundle/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/home/matko/GitHub/LiveVotingBundle/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/home/matko/GitHub/LiveVotingBundle/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/home/matko/GitHub/LiveVotingBundle/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/home/matko/GitHub/LiveVotingBundle/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/home/matko/GitHub/LiveVotingBundle/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/home/matko/GitHub/LiveVotingBundle/src/Acme/DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('/home/matko/GitHub/LiveVotingBundle/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/home/matko/GitHub/LiveVotingBundle/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/home/matko/GitHub/LiveVotingBundle/app/Resources/views');
        $instance->addPath('/home/matko/GitHub/LiveVotingBundle/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '/home/matko/GitHub/LiveVotingBundle/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/home/matko/GitHub/LiveVotingBundle/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/home/matko/GitHub/LiveVotingBundle/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/matko/GitHub/LiveVotingBundle/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/home/matko/GitHub/LiveVotingBundle/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/matko/GitHub/LiveVotingBundle/app/cache/dev',
            'kernel.logs_dir' => '/home/matko/GitHub/LiveVotingBundle/app/logs',
            ...
            'debug.container.dump' => '/home/matko/GitHub/LiveVotingBundle/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/home/matko/GitHub/LiveVotingBundle/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:/home/matko/GitHub/LiveVotingBundle/app/cache/dev/profiler',
            ...
            'router.resource' => '/home/matko/GitHub/LiveVotingBundle/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/matko/GitHub/LiveVotingBundle/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/home/matko/GitHub/LiveVotingBundle/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/home/matko/GitHub/LiveVotingBundle/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/home/matko/GitHub/LiveVotingBundle/app/../web',
            'assetic.write_to' => '/home/matko/GitHub/LiveVotingBundle/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/home/matko/GitHub/LiveVotingBundle/app/cache/dev/doctrine/orm/Proxies',
